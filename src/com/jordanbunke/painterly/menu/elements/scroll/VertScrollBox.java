package com.jordanbunke.painterly.menu.elements.scroll;
...
public final class VertScrollBox extends AbstractVerticalScrollBox {
    public VertScrollBox(
        ...
        super(position, dimensions, menuElements, GameImage::new,
                /* TODO - magic number */ 10, realBottomY, initialOffsetY);
    }
    ...
    protected VertScrollSlider makeSlider(final int maxOffsetY) {
        ...
        final int h = getHeight(),
                scrollBarH = Math.max(/* TODO - magic number */ 10,
