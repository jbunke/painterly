...
public final class EnumUtils {
    public static <T extends Enum<T>> String formattedNameNoPrefix(
            final T element, final String prefix
    ) {
        return (StringUtils.ifTransform(element.name(),
                s -> s.startsWith(prefix),
                s -> s.substring(prefix.length()))).toLowerCase();
    }
